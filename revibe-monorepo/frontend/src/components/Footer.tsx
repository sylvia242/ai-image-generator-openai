      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <img src={logo} alt="UpStaged" className="h-8 w-auto" />
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><a href="#" className="hover:text-primary transition-colors">Design Guide</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Style Guide</a></li>
              <li><a href="#" className="hover:text-primary transition-colors">Style Library</a></li>
        ...
        <div className="border-t border-border mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            © 2025 UpStaged. All rights reserved.
          </p>
